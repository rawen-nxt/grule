...
<template>
  ...
  <div class="container mx-auto relative">
    <div class="b-group-name w100 flex justify-end py-4">
      ...
      <input class="input" type="text" name="groupName" v-model="ruleGroupName" />
    </div>
    <div v-if="rules.length" class="switcher absolute right-0 flex justify-center border rounded">
      <div
    ...
    <div v-if="rules.length" class="flex gap-8">
      ...
      ></GRuleList>
      <GRuleEditor v-show="mode === 'edit'" :key="activeIndex" class="grow"></GRuleEditor>
    </div>
